/**
 * DirectedNode.java Copyright (C) 2006 Tao Chen, Kin Man Poon, Yi Wang, and
 * Nevin L. Zhang
 */
...
public class DirectedNode extends AbstractNode {
     ...
     */
    public final static Predicate<DirectedNode> LEAF_PREDICATE =
        new Predicate<DirectedNode>() {
    ...
    /**
     * Checks whether a node is an internal node.
     */
    public final static Predicate<DirectedNode> INTERNAL_PREDICATE =
        new NotPredicate<DirectedNode>(LEAF_PREDICATE);

    /**
     * Checks whether a node is a parent node.
     */
    public final static Predicate<DirectedNode> ROOT_PREDICATE =
        new Predicate<DirectedNode>() {
            public boolean evaluate(DirectedNode node) {
     ...
     * @see org.latlab.model.DiscreteBeliefNode#attachInEdge(Edge)
     */
     ...
     * @see org.latlab.model.DiscreteBeliefNode#detachInEdge(Edge)
     */
