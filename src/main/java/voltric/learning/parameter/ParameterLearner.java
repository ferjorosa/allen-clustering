...
public class ParameterLearner {
     ...
     */
    public static void computeEM(DiscreteBayesNet bayesNet, DiscreteData dataSet, EmConfig emConfig, ScoreType scoreType, long seed) {
        EM emLearner = new EM(emConfig, scoreType, seed);
