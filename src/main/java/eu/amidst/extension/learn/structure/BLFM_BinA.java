...
public class BLFM_BinA {
    ...
    public Result learnModel(DataOnMemory<DataInstance> data, Map<String, double[]> priors, LogUtils.LogLevel logLevel) {
        ...
        while(keepsImproving && currentSet.size() > 1) {
            ...
            Tuple<Variable, Variable> highestMiVariablesIndexes = highestMiVariables(currentSet, currentMIsMatrix, dag);
            ...
            vbem_local.learnModel(copyPlateauStructure, dag, newLatentVar);
    ...
    private Tuple<Variable, Variable> highestMiVariables(Set<Variable> currentSet, Map<Variable, Map<Variable, Double>> currentMIsMatrix, DAG dag) {
    ...
    private PlateuStructure greedyCardIncrease(Variable latentVar, PlateuStructure model, DAG dag) {
        ...
        while(true) {
            ...
            vbem_local.learnModel(copyPlateauStructure, dag, latentVar);
