...
public class BLFM_BinG {
    ...
    public Result learnModel(DataOnMemory<DataInstance> data, Map<String, double[]> priors, LogUtils.LogLevel logLevel) {
        ...
        while(keepsImproving && currentSet.size() > 1) {
            ...
            Tuple<Variable, Variable> highestMiVariablesIndexes = highestMiVariables(currentMIsMatrix);
    ...
    private Tuple<Variable, Variable> highestMiVariables(Map<Variable, Map<Variable, Double>> misMatrix) {
