...
public class BlfmHcIncreaseCard implements BlfmHcOperator {

    private int maxCardinality;

    public BlfmHcIncreaseCard(int maxCardinality) {
    ...
    public Result apply(PlateuStructure plateuStructure, DAG dag, boolean globalVBEM) {
        ...
        for(Variable variable: copyVariables){
            ...
            if(variable.getAttribute() == null && variable.getNumberOfStates() < this.maxCardinality) {
