...
public class BLFM_IncLearner {
    ...
    private Result estimateLocalCardinality(List<String> discreteLatentVars, DAG dag, PlateuStructure currentModel) {
        ...
        BltmHcIncreaseCard increaseCardOperator = new BltmHcIncreaseCard(maxCardinality, this.localVBEMConfig, this.iterationVBEMConfig);
        BltmHcDecreaseCard decreaseCardOperator = new BltmHcDecreaseCard(2, this.localVBEMConfig, this.iterationVBEMConfig);
